...
#### Functionality
For the purposes of this application, the `ceasar()` function takes an input string, an integer value, and an optional boolean value (which defaults to `true` if none is passed).
